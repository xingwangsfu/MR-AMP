...
%                     end
                    ...
                    NumIt = 25;                 % Max # of optimize iters
                    Tol = 1e-8;                 % Early terminate tolerance
                    for i = 1:NumIt
...
%                         zvar = (1./zvar0 + 2*lam).^(-1);
                ...
                case true
                    ...
                    PMonesY = sign(obj.y - 0.1);	% Convert {0,1} to {-1,1}
                    a = obj.scale;                  % Shorthand for scale
...
%                     % fminunc approach - Use gradient methods to solve the
